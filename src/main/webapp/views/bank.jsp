        ...
        <div class="container">
            <div class="breadcrumb-content text-center">
                <ul>
                    ...
                    <li class="active">Transfer Points to Bank </li>
                </ul>
            </div>
        </div>
    </div> 
                        ...
                        <div class="tab-content">
                            <div id="lg1" class="tab-pane active">
                                <div class="login-form-container">
                                    ...
                                    %>
                                        <form action="${pageContext.request.contextPath}/TransferPointsToBankController" method="post">
                                            <input type="number" name="accnumber" placeholder="Account Number" required>
                                            ...
                                            <div class="button-box">
                                                ...
                                                <button type="submit" onclick="return confirm('Please press OK to confirm transfer of points to Bank');">Transfer Points</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
